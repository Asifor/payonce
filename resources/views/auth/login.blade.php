...
<body class="layout-login-centered-boxed">
    ...
    <div class="layout-login-centered-boxed__form card">
        ...
        @if ($errors->any())
            <ul class="list-disc list-inside text-sm text-red-600 alert alert-danger">
        ...
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-5 navbar-light">
            ...
            <p class="m-0 mt-2">Login to access your PayOnce Account </p>
        </div>
        ...
        <form action="{{ route('login') }}" method="post">
            ...
            <div class="form-group text-center">
                ...
                Don't have an account? <a class="text-body text-underline" href="{{ route('register') }}@if(!empty(request('token')))?token={{ request('token') }} @endif">Sign up!</a>
            </div>
        </form>
    </div>
