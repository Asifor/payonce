                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        @php ++$i; @endphp
                            ...
                            <tr class="row-{{ $transaction->id }}">
                                ...
                                <td>
                                    {{ ucwords($transaction->account_name) }}
                                </td>

                                <td style="width: 140px;">{{ ucwords($transaction->bank_name) }}</td>
        ...
        delBtns.forEach((btn) => {
            ...
            $(btn).click( () => {
                ...
                $.ajax({
                    ...
                    url : "/transactions/"+ btn.dataset.transId +"/delete",
                    method : "GET",
                    success      : (response) => {
